...
--8
SELECT O1.SHIP--, O1.BATTLE, O2.BATTLE
FROM OUTCOMES O1 JOIN OUTCOMES O2 ON O1.SHIP = O2.SHIP
WHERE O1.RESULT = 'damaged' AND O2.RESULT = 'ok' AND
(SELECT COUNT(*) FROM OUTCOMES WHERE BATTLE = O1.BATTLE)
<
(SELECT COUNT(*) FROM OUTCOMES WHERE BATTLE = O2.BATTLE)
